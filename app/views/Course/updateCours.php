    ...
    <div class="container px-4 px-sm-6 px-xxl-0 d-flex align-items-center justify-content-center min-vh-100 position-relative z-10">
        <div class="bg-white p-5 rounded shadow-lg w-100 max-w-lg">
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    <input type="text" name="titre" value="<?= $data['cour']->titre ?>" placeholder="Course Title" class="form-control">
                </div>
                <div class="mb-4">
                    <input type="text" name="description" value="<?= $data['cour']->description ?>" placeholder="Short Description" class="form-control">
                </div>
                <?php if($data['cour']->contenu != null ):?>
                <div class="mb-4 d-none" id="TextContent">
                    <textarea name="content" rows="6" placeholder="Course Content" class="form-control">
                        <?php ($data['cour']->contenu != null) ? $data['cour']->contenu : '' ?>
                    </textarea>
                </div>
                <?php else:?>
                ...
                <div class="mb-4">
                    <input type="number" name="price" value="<?= $data['cour']->price ?>" placeholder="$" class="form-control">
                </div>
